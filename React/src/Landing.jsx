        ...
        <Layout>
            ...
            <div className="container my-5">
                ...
                <div className="col-lg-4 offset-lg-1 p-0 overflow-hidden shadow-lg">
                    <img className="rounded-lg-3" src={"https://www.celebrityfitness.co.th/th/-/media/project/evolution-wellness/celebrity-fitness/south-east-asia/malaysia/blogs/killer-routine-for-sexy-sculpted-arms/tiles1.jpg"} alt="fitbook" style={{width:"720px"}}/>
                </div>
                </div>
            </div>
